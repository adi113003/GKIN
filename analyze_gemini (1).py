...
Setup:
  ...
  3. pip install google-generativeai openpyxl
...
def analyze_article(model, article_text: str) -> dict:
...
def main(xlsx_path: str):
    ...
    for row in range(2, ws.max_row + 1):
        ...
        if key in cache:
            ...
            try:
                result = analyze_article(model, text)
                cache[key] = result
                save_cache(cache)
                ok += 1
        ...
        # Write summary fields into the sheet
